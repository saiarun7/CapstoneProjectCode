               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href="index.html">Vehicle Registration Details By Vehicle Number</a> </div>
                     </div>
                  </div>
               </div>
...
<center><tr>
        <td><h1>&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Login Here..</h1></td>
    </tr></center>
 
<table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
    <form method="post" action="usrloginact.jsp">
<tr>
...
<td><a href="usersignup.jsp">Click Here to Register</a></td>
<table border='0' cellpadding='0' cellspacing='0' width='480px' align='center'>
<tr>
    <td align='center'><input type='submit' name='REGISTER' value="Login Here"></td>
</tr>
</table>
    </form>
</table>
