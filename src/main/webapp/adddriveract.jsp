...
<html>
    ...
    <body>
        ...
        try{
           ...
           str1 = request.getParameter("dname");
           str2 = request.getParameter("dsname");
           str3 = request.getParameter("dob");
           str4 = request.getParameter("addrs");
           str5 = request.getParameter("phone");
