...
<html lang="en">
   ...
   <body class="main-layout">
          ...
          <center>
              ...
              <tr>
                ...
                <td width="171" bgcolor="#FF0000"><div align="center" class="style22">Email </div></td>
                 <td width="171" bgcolor="#FF0000"><div align="center" class="style22">Generate QRcode </div></td>
              </tr>
              <%
	...
	int i=0,j=0,k=0;
      	...
      	try 
	{
        String query="select * from driver_DB"; 
	...
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                ...
                <td><div align="center" class="style23"><a href="generateQrcodeDriver.jsp?id=<%=s1%>">Generate</a></div></td>-->
	...
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                ...
                <td><div align="center" class="style23"><%=s3%></div></td>
                <td><div align="center" class="style23"><%=s4%></div></td>
                <td><div align="center" class="style23"><a href="QrCodevehcile.jsp?id=<%=s1%>">Generate</a></div></td>
                <!--<td><div align="center" class="style23"><a href="editdriverstatus_1.jsp?id=<%=s1%>">InActivate Driver</a></div></td>-->
                -->
              </tr>
              <%
...
%>
       ...
       <center>
      	...
      	try 
	{
        String query="select * from license_DB"; 
           Statement st=connection.createStatement();
           ResultSet rs=st.executeQuery(query);
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                ...
                <td><div align="center" class="style23"><a href="QrCodelicense.jsp?id=<%=s1%>">Generate</a></div></td>
