...
<center><tr>
        <td><h1>&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Register Here..</h1></td>
    </tr></center>
 
<table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
    <form method="post" action="userregact.jsp">
<tr>
...
<tr>
    ...
    <td><input type='text' name='addrs' required="true"></td>
</tr>
<tr> <td>&nbsp;</td> </tr>
<table border='0' cellpadding='0' cellspacing='0' width='480px' align='center'>
<tr>
    <td align='center'><input type='submit' name='REGISTER' value="Register Here"></td>
</tr>
</table>
    </form>
</table>
