      ...
      <div>
          <center>
              ...
              <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
                <center><tr>
                   <td><h1>Add License Details</h1></td>
                </tr><center>
                 <form method="post" action="addlicact.jsp">
                <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
                <tr>
                    <td align='center'>Driving License Number:</td>
                ...
                <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td align='center'>Son/Daughter/Wife of:</td>
                    <td><input type='text' name='sodowo'></td>
                </tr>
                <tr> <td>&nbsp;</td> </tr>
                <tr>
                ...
                <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td align='center'>Issues Date:</td>
                   <td><input type='date' name='issuedt'></td>
                </tr>
                <tr> <td>&nbsp;</td> </tr>
                <tr>
                    <td align='center'>Exp Date:</td>
                    <td><input type='date' name='expdt'></td>
                </tr>
